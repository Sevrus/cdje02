    ...
    return (
        <div className="legal-notice">
            <div className="legal-notice__header">
                <div className="legal-notice__header__title">
                    Mentions légales
                </div>
            ...
            <div className="legal-notice__content">
                ...
                <div className="legal-notice__content__article">
                    <div className="legal-notice__content__article__title">
                        ARTICLE 1 - L'EDITEUR
                    </div>
                    <div className="legal-notice__content__article__content">
                ...
                <div className="legal-notice__content__article">
                    ...
                    <div className="legal-notice__content__article__content">
                        ...
                        GARE 57200 SARREGUEMINES , avec le numéro de téléphone : 0970808911 + adresse mail de
                        contact
                    </div>
                </div>
